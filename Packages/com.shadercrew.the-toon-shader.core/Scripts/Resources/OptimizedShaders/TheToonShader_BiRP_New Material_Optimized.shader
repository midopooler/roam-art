...
Shader "TheToonShader/Optimized/BiRP/TheToonShader_New Material_Optimized"
{
   Properties
   {
...
_TheToonShaderIdentifier("_TheToonShaderIdentifier", Float) = 1.0
   ...
   SubShader
   {
	...
	CGINCLUDE
		#define _USE_OPTIMIZATION_DEFINES 1
		#define _SHADING_FUNCTION 0
		#define _ENABLE_STYLING 1
		#define _ENABLE_SHADING_STYLING 1
		#define _SHADING_STYLING_BLENDING 0
		#define _SHADING_STYLING_DRAWSPACE 1
		#define _SHADING_STYLING_COORDINATESYSTEM 0
		#define _SHADING_STYLE 0
		#define _SHADING_STYLING_NUMBER_OF_CELLS_HATCHING 2
	ENDCG
