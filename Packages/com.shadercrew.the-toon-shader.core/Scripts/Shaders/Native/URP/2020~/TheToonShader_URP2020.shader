...
ZWrite On
   ...
   #define _URP 1
            ...
            #include "Packages/com.shadercrew.the-toon-shader.core/Scripts/Shaders/xxSharedTTSDependecies/ModifiedLightingFunctions/URP/LightingModifiedForToon2020.hlsl"
